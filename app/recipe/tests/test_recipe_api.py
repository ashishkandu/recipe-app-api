...
def detail_url(recipe_id):
    """Creeate and return a recipe detail URL."""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_update_user_returns_error(self):
        ...
        new_user = create_user(email='another@example.com', password='test123')
        recipe = create_recipe(user=self.user)
    ...
    def test_update_recipe_assign_tag(self):
        """Test assigning an existing tag when updaging a recipe."""
    ...
    def test_create_recipe_with_new_ingredientes(self):
    ...
    def test_filter_by_ingredients(self):
        ...
        r3 = create_recipe(user=self.user, title='Red Letinl Daal')
